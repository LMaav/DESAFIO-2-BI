...
public final class ActivityClientesBinding implements ViewBinding {
  ...
  private ActivityClientesBinding(@NonNull LinearLayout rootView, @NonNull Button btnAdicionar,
      @NonNull ListView listaClientes) {
  ...
  public static ActivityClientesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.listaClientes;
      ListView listaClientes = ViewBindings.findChildViewById(rootView, id);
      if (listaClientes == null) {
        break missingId;
      }

      return new ActivityClientesBinding((LinearLayout) rootView, btnAdicionar, listaClientes);
    }
